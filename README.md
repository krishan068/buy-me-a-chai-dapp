...
🍵 A simple and beginner-friendly Web3 decentralized application that allows users to buy chai using cryptocurrency and attach a custom message with their payment.

This project is built to help beginners understand smart contracts, wallet interaction, and frontend–blockchain integration in a fun and practical way.
